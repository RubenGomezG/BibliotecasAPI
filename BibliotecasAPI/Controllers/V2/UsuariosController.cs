...
namespace BibliotecasAPI.Controllers.V2
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        [HttpPost("registro", Name = "RegistrarV2")]
        ...
        [HttpGet(Name = "ObtenerUsuariosV2")]
        ...
        [HttpPut(Name = "ActualizarUsuarioV2")]
        [Authorize]
        ...
        [HttpGet("renovar-token", Name = "RenovarTokenV2")]
        [Authorize]
        ...
        [HttpPost("hacer-admin", Name = "HacerAdminV2")]
        [Authorize(Policy = "esAdmin")]
        ...
        [HttpPost("quitar-admin", Name = "QuitarAdminV2")]
        [Authorize(Policy = "esAdmin")]
